    ...
    SubShader
    {
        ...
        Pass
        {
		    ...
		    float computeWeight(float3 worldPos)
		    {
                ...
                #else
			        float d = distance(worldPos, float3(_WaveWorldPos.x, _ViewOrigin.y, _WaveWorldPos.z));
            ...
            {
                float w = computeWeight(input.positionWS);
                ...
                #if _EXTENDED_WAVE
                    uv = input.positionWS.xz * _InvDomainSize;
                #endif
