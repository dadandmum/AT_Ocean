...
namespace ATOcean
{
    public class ATO_FFTOceanCascade
    {
        ...
        public void RunInitials(ATO_FFTOceanData wavesSettings, float lengthScale,
        ...
        public void InitMaterial( Material refMat )
        {
        ...
        public void CalculateInitials(ATO_FFTOceanData wavesSettings, float lengthScale,
                                      float cutoffLow, float cutoffHigh)
        {
            lambda = wavesSettings.lambda;
